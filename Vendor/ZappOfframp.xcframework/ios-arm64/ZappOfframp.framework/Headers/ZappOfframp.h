...
+ (void)Skie_Suspend__45__requestPaymentDetailsDispatchReceiver:(id<ZappOfframpAppleOfframpPaymentDetailsProvider>)dispatchReceiver orderId:(NSString *)orderId currencyCode:(NSString *)currencyCode fiatAmount:(NSString *)fiatAmount suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__45__requestPaymentDetails(dispatchReceiver:orderId:currencyCode:fiatAmount:suspendHandler:)")));
+ (void)Skie_Suspend__46__createDispatchReceiver:(ZappOfframpAppleOfframpClientCompanion *)dispatchReceiver networkName:(NSString *)networkName seedPhrase:(NSString *)seedPhrase pimlicoApiKey:(NSString *)pimlicoApiKey storage:(id<ZappOfframpAppleOfframpStorage>)storage bridge:(id<ZappOfframpAppleOfframpBridge> _Nullable)bridge rpcUrl:(NSString * _Nullable)rpcUrl subgraphUrl:(NSString * _Nullable)subgraphUrl sponsorshipPolicyId:(NSString * _Nullable)sponsorshipPolicyId suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__46__create(dispatchReceiver:networkName:seedPhrase:pimlicoApiKey:storage:bridge:rpcUrl:subgraphUrl:sponsorshipPolicyId:suspendHandler:)")));
+ (void)Skie_Suspend__47__ensureFundedDispatchReceiver:(id<ZappOfframpOfframpFunding>)dispatchReceiver account:(ZappOfframpAddress *)account request:(ZappOfframpOfframpRequest *)request resumeHandle:(NSString * _Nullable)resumeHandle onBridgeStarted:(id<ZappOfframpKotlinSuspendFunction1>)onBridgeStarted suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__47__ensureFunded(dispatchReceiver:account:request:resumeHandle:onBridgeStarted:suspendHandler:)")));
+ (void)Skie_Suspend__48__invokeDispatchReceiver:(id<ZappOfframpKotlinSuspendFunction1>)dispatchReceiver p1:(id _Nullable)p1 suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__48__invoke(dispatchReceiver:p1:suspendHandler:)")));
+ (void)Skie_Suspend__49__pullbackTargetDispatchReceiver:(id<ZappOfframpOfframpRefund>)dispatchReceiver account:(ZappOfframpAddress *)account amount:(id)amount suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__49__pullbackTarget(dispatchReceiver:account:amount:suspendHandler:)")));
...
+ (void)Skie_Suspend__50__bridgeDispatchReceiver:(id<ZappOfframpOfframpTopUp>)dispatchReceiver account:(ZappOfframpAddress *)account usdc:(id)usdc resumeHandle:(NSString * _Nullable)resumeHandle onBridgeStarted:(id<ZappOfframpKotlinSuspendFunction1>)onBridgeStarted suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__50__bridge(dispatchReceiver:account:usdc:resumeHandle:onBridgeStarted:suspendHandler:)")));
+ (void)Skie_Suspend__51__requestPaymentDetailsDispatchReceiver:(id<ZappOfframpOfframpPaymentDetailsProvider>)dispatchReceiver orderId:(ZappOfframpBigInteger *)orderId accepted:(ZappOfframpOrderSnapshot *)accepted request:(ZappOfframpOfframpRequest *)request suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__51__requestPaymentDetails(dispatchReceiver:orderId:accepted:request:suspendHandler:)")));
+ (void)Skie_Suspend__52__getDispatchReceiver:(id<ZappOfframpOrderRecipientUpiCache>)dispatchReceiver orderId:(NSString *)orderId suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__52__get(dispatchReceiver:orderId:suspendHandler:)")));
+ (void)Skie_Suspend__53__putDispatchReceiver:(id<ZappOfframpOrderRecipientUpiCache>)dispatchReceiver orderId:(NSString *)orderId recipientUpi:(NSString *)recipientUpi suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__53__put(dispatchReceiver:orderId:recipientUpi:suspendHandler:)")));
+ (void)Skie_Suspend__54__getDispatchReceiver:(id<ZappOfframpRelayIdentityStore>)dispatchReceiver suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__54__get(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__55__setDispatchReceiver:(id<ZappOfframpRelayIdentityStore>)dispatchReceiver identity:(ZappOfframpRelayIdentity *)identity suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__55__set(dispatchReceiver:identity:suspendHandler:)")));
+ (void)Skie_Suspend__56__selectCircleForOrderDispatchReceiver:(ZappOfframpCircleRouter *)dispatchReceiver circles:(NSArray<ZappOfframpCircleForRouting *> *)circles orderCurrency:(NSString *)orderCurrency validateCircle:(id<ZappOfframpKotlinSuspendFunction1>)validateCircle suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__56__selectCircleForOrder(dispatchReceiver:circles:orderCurrency:validateCircle:suspendHandler:)")));
+ (void)Skie_Suspend__57__fetchOrderDispatchReceiver:(id<ZappOfframpOrderReadSource>)dispatchReceiver orderId:(ZappOfframpBigInteger *)orderId suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__57__fetchOrder(dispatchReceiver:orderId:suspendHandler:)")));
+ (void)Skie_Suspend__58__circlesForRoutingDispatchReceiver:(ZappOfframpSubgraphClient *)dispatchReceiver currencyBytes32Hex:(NSString *)currencyBytes32Hex suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__58__circlesForRouting(dispatchReceiver:currencyBytes32Hex:suspendHandler:)")));
+ (void)Skie_Suspend__59__ordersForUserDispatchReceiver:(ZappOfframpSubgraphClient *)dispatchReceiver userAddress:(NSString *)userAddress first:(int32_t)first skip:(int32_t)skip suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__59__ordersForUser(dispatchReceiver:userAddress:first:skip:suspendHandler:)")));
...
+ (void)Skie_Suspend__60__rawOrderByIdDispatchReceiver:(ZappOfframpSubgraphClient *)dispatchReceiver orderId:(NSString *)orderId suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__60__rawOrderById(dispatchReceiver:orderId:suspendHandler:)")));
+ (void)Skie_Suspend__61__isMerchantAvailableDispatchReceiver:(id<ZappOfframpOfframpDriver>)dispatchReceiver usdc:(id)usdc currency:(ZappOfframpCurrencyCode *)currency suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__61__isMerchantAvailable(dispatchReceiver:usdc:currency:suspendHandler:)")));
+ (void)Skie_Suspend__62__resolveAmountDispatchReceiver:(id<ZappOfframpDynamicPixResolver>)dispatchReceiver locationUrl:(NSString *)locationUrl orderId:(NSString * _Nullable)orderId suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__62__resolveAmount(dispatchReceiver:locationUrl:orderId:suspendHandler:)")));
+ (void)Skie_Suspend__63__fetchAllDispatchReceiver:(ZappOfframpP2pOrderHistorySource *)dispatchReceiver userAddress:(ZappOfframpAddress *)userAddress maxOrders:(int32_t)maxOrders suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__63__fetchAll(dispatchReceiver:userAddress:maxOrders:suspendHandler:)")));
+ (void)Skie_Suspend__64__parseDispatchReceiver:(ZappOfframpPaymentQrParser *)dispatchReceiver currency:(ZappOfframpCurrencyCode *)currency qrData:(NSString *)qrData dynamicPixResolver:(id<ZappOfframpDynamicPixResolver> _Nullable)dynamicPixResolver orderId:(NSString * _Nullable)orderId suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__64__parse(dispatchReceiver:currency:qrData:dynamicPixResolver:orderId:suspendHandler:)")));
+ (void)Skie_Suspend__65__parseDispatchReceiver:(ZappOfframpPixQrParser *)dispatchReceiver qrData:(NSString *)qrData resolver:(id<ZappOfframpDynamicPixResolver> _Nullable)resolver orderId:(NSString * _Nullable)orderId suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__65__parse(dispatchReceiver:qrData:resolver:orderId:suspendHandler:)")));
+ (void)Skie_Suspend__66__upgradeDispatchReceiver:(ZappOfframpKtor_httpOutgoingContentProtocolUpgrade *)dispatchReceiver input:(id<ZappOfframpKtor_ioByteReadChannel>)input output:(id<ZappOfframpKtor_ioByteWriteChannel>)output engineContext:(id<ZappOfframpKotlinCoroutineContext>)engineContext userContext:(id<ZappOfframpKotlinCoroutineContext>)userContext suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__66__upgrade(dispatchReceiver:input:output:engineContext:userContext:suspendHandler:)")));
+ (void)Skie_Suspend__67__flushDispatchReceiver:(id<ZappOfframpKtor_ioByteWriteChannel>)dispatchReceiver suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__67__flush(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__68__flushAndCloseDispatchReceiver:(id<ZappOfframpKtor_ioByteWriteChannel>)dispatchReceiver suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__68__flushAndClose(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__69__writeToDispatchReceiver:(ZappOfframpKtor_httpOutgoingContentWriteChannelContent *)dispatchReceiver channel:(id<ZappOfframpKtor_ioByteWriteChannel>)channel suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__69__writeTo(dispatchReceiver:channel:suspendHandler:)")));
...
+ (void)Skie_Suspend__70__getUsdcBalanceExtensionReceiver:(ZappOfframpBaseRpcClient *)extensionReceiver usdcAddress:(ZappOfframpAddress *)usdcAddress owner:(ZappOfframpAddress *)owner suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__70__getUsdcBalance(extensionReceiver:usdcAddress:owner:suspendHandler:)")));
+ (void)Skie_Suspend__71__getAdditionalOrderDetailsExtensionReceiver:(ZappOfframpBaseRpcClient *)extensionReceiver diamondAddress:(ZappOfframpAddress *)diamondAddress orderId:(ZappOfframpBigInteger *)orderId suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__71__getAdditionalOrderDetails(extensionReceiver:diamondAddress:orderId:suspendHandler:)")));
+ (void)Skie_Suspend__72__getPriceConfigExtensionReceiver:(ZappOfframpBaseRpcClient *)extensionReceiver diamondAddress:(ZappOfframpAddress *)diamondAddress currency:(ZappOfframpCurrencyCode *)currency suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__72__getPriceConfig(extensionReceiver:diamondAddress:currency:suspendHandler:)")));
+ (void)Skie_Suspend__73__getPayFeeConfigExtensionReceiver:(ZappOfframpBaseRpcClient *)extensionReceiver diamondAddress:(ZappOfframpAddress *)diamondAddress currency:(ZappOfframpCurrencyCode *)currency suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__73__getPayFeeConfig(extensionReceiver:diamondAddress:currency:suspendHandler:)")));
+ (void)Skie_Suspend__74__getSmallOrderFixedFeePayExtensionReceiver:(ZappOfframpBaseRpcClient *)extensionReceiver diamondAddress:(ZappOfframpAddress *)diamondAddress currency:(ZappOfframpCurrencyCode *)currency suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__74__getSmallOrderFixedFeePay(extensionReceiver:diamondAddress:currency:suspendHandler:)")));
+ (void)Skie_Suspend__75__getSmallOrderThresholdExtensionReceiver:(ZappOfframpBaseRpcClient *)extensionReceiver diamondAddress:(ZappOfframpAddress *)diamondAddress currency:(ZappOfframpCurrencyCode *)currency suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__75__getSmallOrderThreshold(extensionReceiver:diamondAddress:currency:suspendHandler:)")));
