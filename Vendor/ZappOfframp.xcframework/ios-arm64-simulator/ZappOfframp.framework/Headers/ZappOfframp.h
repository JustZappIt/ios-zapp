...
@property (readonly) NSString *address __attribute__((swift_name("address")));
@property (readonly) NSString * _Nullable balanceDisplay __attribute__((swift_name("balanceDisplay")));
@property (readonly) NSString * _Nullable balanceMicros __attribute__((swift_name("balanceMicros")));
...
- (instancetype)initWithAddress:(NSString *)address balanceMicros:(NSString * _Nullable)balanceMicros balanceDisplay:(NSString * _Nullable)balanceDisplay explorerUrl:(NSString *)explorerUrl canBridgeToBase:(BOOL)canBridgeToBase canRefundToZec:(BOOL)canRefundToZec __attribute__((swift_name("init(address:balanceMicros:balanceDisplay:explorerUrl:canBridgeToBase:canRefundToZec:)"))) __attribute__((objc_designated_initializer));
- (ZappOfframpAppleOfframpAccountSummary *)doCopyAddress:(NSString *)address balanceMicros:(NSString * _Nullable)balanceMicros balanceDisplay:(NSString * _Nullable)balanceDisplay explorerUrl:(NSString *)explorerUrl canBridgeToBase:(BOOL)canBridgeToBase canRefundToZec:(BOOL)canRefundToZec __attribute__((swift_name("doCopy(address:balanceMicros:balanceDisplay:explorerUrl:canBridgeToBase:canRefundToZec:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)discardTopUpCheckpointWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("discardTopUpCheckpoint(completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)hasTopUpCheckpointWithCompletionHandler:(void (^)(ZappOfframpBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("hasTopUpCheckpoint(completionHandler:)")));
...
- (id<ZappOfframpKotlinx_coroutines_coreFlow>)payQuote:(ZappOfframpAppleOfframpQuote *)quote paymentDetailsProvider:(id<ZappOfframpAppleOfframpPaymentDetailsProvider>)paymentDetailsProvider payeeName:(NSString * _Nullable)payeeName __attribute__((swift_name("pay(quote:paymentDetailsProvider:payeeName:)")));
...
- (id<ZappOfframpKotlinx_coroutines_coreFlow>)resumePaymentPaymentDetailsProvider:(id<ZappOfframpAppleOfframpPaymentDetailsProvider>)paymentDetailsProvider __attribute__((swift_name("resumePayment(paymentDetailsProvider:)")));

/**
 * @note This method converts instances of Exception to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)topUpCheckpointMicrosWithCompletionHandler:(void (^)(NSString * _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("topUpCheckpointMicros(completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)createNetworkName:(NSString *)networkName seedPhrase:(NSString *)seedPhrase pimlicoApiKey:(NSString *)pimlicoApiKey storage:(id<ZappOfframpAppleOfframpStorage>)storage bridge:(id<ZappOfframpAppleOfframpBridge> _Nullable)bridge rpcUrl:(NSString * _Nullable)rpcUrl subgraphUrl:(NSString * _Nullable)subgraphUrl sponsorshipPolicyId:(NSString * _Nullable)sponsorshipPolicyId pixProxyUrl:(NSString * _Nullable)pixProxyUrl pixJwtPublicKeyBase64:(NSString * _Nullable)pixJwtPublicKeyBase64 pixJwtKeyId:(NSString * _Nullable)pixJwtKeyId completionHandler:(void (^)(ZappOfframpAppleOfframpClient * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("create(networkName:seedPhrase:pimlicoApiKey:storage:bridge:rpcUrl:subgraphUrl:sponsorshipPolicyId:pixProxyUrl:pixJwtPublicKeyBase64:pixJwtKeyId:completionHandler:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AppleOfframpPaymentDetails")))
@interface ZappOfframpAppleOfframpPaymentDetails : ZappOfframpBase
...
- (instancetype)initWithRawPayload:(NSString *)rawPayload paymentAddress:(NSString *)paymentAddress fiatAmount:(NSString * _Nullable)fiatAmount __attribute__((swift_name("init(rawPayload:paymentAddress:fiatAmount:)"))) __attribute__((objc_designated_initializer));
- (ZappOfframpAppleOfframpPaymentDetails *)doCopyRawPayload:(NSString *)rawPayload paymentAddress:(NSString *)paymentAddress fiatAmount:(NSString * _Nullable)fiatAmount __attribute__((swift_name("doCopy(rawPayload:paymentAddress:fiatAmount:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
 ...
 */
__attribute__((swift_name("AppleOfframpPaymentDetailsProvider")))
@protocol ZappOfframpAppleOfframpPaymentDetailsProvider
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)requestPaymentDetailsOrderId:(NSString *)orderId currencyCode:(NSString *)currencyCode fiatAmount:(NSString *)fiatAmount completionHandler:(void (^)(ZappOfframpAppleOfframpPaymentDetails * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("requestPaymentDetails(orderId:currencyCode:fiatAmount:completionHandler:)")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (ZappOfframpAppleStorageValue * _Nullable)checkpointJsonAndReturnError:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("checkpointJson()")));

/**
 * @note This method converts instances of Exception to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (BOOL)clearCheckpointAndReturnError:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("clearCheckpoint()")));

/**
 * @note This method converts instances of Exception to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (BOOL)clearRefundCheckpointAndReturnError:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("clearRefundCheckpoint()")));

/**
 * @note This method converts instances of Exception to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (BOOL)clearTopUpCheckpointAndReturnError:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("clearTopUpCheckpoint()")));

/**
 * @note This method converts instances of Exception to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (ZappOfframpAppleStorageValue * _Nullable)paymentAddressOrderId:(NSString *)orderId error:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("paymentAddress(orderId:)")));

/**
 * @note This method converts instances of Exception to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (ZappOfframpAppleStorageValue * _Nullable)refundCheckpointJsonAndReturnError:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("refundCheckpointJson()")));

/**
 * @note This method converts instances of Exception to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (ZappOfframpAppleStorageValue * _Nullable)relayPrivateKeyAndReturnError:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("relayPrivateKey()")));

/**
 * @note This method converts instances of Exception to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (ZappOfframpAppleStorageValue * _Nullable)relayPublicKeyAndReturnError:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("relayPublicKey()")));

/**
 * @note This method converts instances of Exception to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (BOOL)storeCheckpointJsonValue:(NSString *)value error:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("storeCheckpointJson(value:)")));

/**
 * @note This method converts instances of Exception to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (BOOL)storePaymentAddressOrderId:(NSString *)orderId paymentAddress:(NSString *)paymentAddress error:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("storePaymentAddress(orderId:paymentAddress:)")));

/**
 * @note This method converts instances of Exception to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (BOOL)storeRefundCheckpointJsonValue:(NSString *)value error:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("storeRefundCheckpointJson(value:)")));

/**
 * @note This method converts instances of Exception to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (BOOL)storeRelayPrivateKeyHex:(NSString *)privateKeyHex publicKeyHex:(NSString *)publicKeyHex error:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("storeRelay(privateKeyHex:publicKeyHex:)")));

/**
 * @note This method converts instances of Exception to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (BOOL)storeTopUpCheckpointJsonValue:(NSString *)value error:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("storeTopUpCheckpointJson(value:)")));

/**
 * @note This method converts instances of Exception to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (ZappOfframpAppleStorageValue * _Nullable)topUpCheckpointJsonAndReturnError:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("topUpCheckpointJson()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AppleStorageValue")))
@interface ZappOfframpAppleStorageValue : ZappOfframpBase
...
- (ZappOfframpAppleStorageValue *)doCopyValue:(NSString * _Nullable)value __attribute__((swift_name("doCopy(value:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)awaitSettlementHandle:(NSString *)handle completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("awaitSettlement(handle:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)markTransferStartingHandle:(NSString *)handle amount:(id)amount completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("markTransferStarting(handle:amount:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)markTransferSubmittedHandle:(NSString *)handle amount:(id)amount txHash:(ZappOfframpTxHash *)txHash completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("markTransferSubmitted(handle:amount:txHash:completionHandler:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RefundResume")))
@interface ZappOfframpRefundResume : ZappOfframpBase
...
@property (readonly) BOOL transferStarted __attribute__((swift_name("transferStarted")));
@property (readonly) ZappOfframpTxHash * _Nullable txHash __attribute__((swift_name("txHash")));
- (instancetype)initWithHandle:(NSString *)handle amount:(id)amount transferStarted:(BOOL)transferStarted txHash:(ZappOfframpTxHash * _Nullable)txHash __attribute__((swift_name("init(handle:amount:transferStarted:txHash:)"))) __attribute__((objc_designated_initializer));
- (ZappOfframpRefundResume *)doCopyHandle:(NSString *)handle amount:(id)amount transferStarted:(BOOL)transferStarted txHash:(ZappOfframpTxHash * _Nullable)txHash __attribute__((swift_name("doCopy(handle:amount:transferStarted:txHash:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
 ...
 */
- (id<ZappOfframpKotlinx_coroutines_coreFlow>)bridgeFundsBackToZecOrderId:(ZappOfframpBigInteger * _Nullable)orderId resume:(ZappOfframpRefundResume * _Nullable)resume __attribute__((swift_name("bridgeFundsBackToZec(orderId:resume:)")));
...
- (instancetype)initWithHttpClient:(ZappOfframpKtor_client_coreHttpClient *)httpClient jwtVerifier:(id<ZappOfframpPixJwtVerifier>)jwtVerifier __attribute__((swift_name("init(httpClient:jwtVerifier:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("P2pOrderLimits")))
@interface ZappOfframpP2pOrderLimits : ZappOfframpBase
@property (class, readonly, getter=shared) ZappOfframpP2pOrderLimits *shared __attribute__((swift_name("shared")));
@property (readonly) id MAX_ORDER __attribute__((swift_name("MAX_ORDER")));
@property (readonly) int64_t QR_AMOUNT_TOLERANCE_PERCENT __attribute__((swift_name("QR_AMOUNT_TOLERANCE_PERCENT")));
+ (instancetype)alloc __attribute__((unavailable));

/** Contract-independent client safety limits applied both when quoting and when committing a QR. */
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)p2pOrderLimits __attribute__((swift_name("init()")));
@end
...
/** Authenticates the compact JWS returned by the configured Dynamic PIX proxy. */
__attribute__((swift_name("PixJwtVerifier")))
@protocol ZappOfframpPixJwtVerifier
@required

/** Throws [PixFetchException] unless [signature] authenticates [signingInput]. */
- (void)verifyAlgorithm:(NSString *)algorithm keyId:(NSString * _Nullable)keyId signingInput:(ZappOfframpKotlinByteArray *)signingInput signature:(ZappOfframpKotlinByteArray *)signature __attribute__((swift_name("verify(algorithm:keyId:signingInput:signature:)")));
@end
...
- (instancetype)initWithHttpClient:(ZappOfframpKtor_client_coreHttpClient *)httpClient proxyUrl:(NSString *)proxyUrl jwtVerifier:(id<ZappOfframpPixJwtVerifier>)jwtVerifier __attribute__((swift_name("init(httpClient:proxyUrl:jwtVerifier:)"))) __attribute__((objc_designated_initializer));
...
/**
 * Pinned RS256 verifier for Dynamic PIX proxy responses.
 *
 * [publicKeyDerBase64] is a base64-encoded X.509 SubjectPublicKeyInfo RSA public key. [expectedKeyId]
 * is mandatory so key rotation remains explicit and an attacker cannot select a different key via
 * the JWT header. Public-key configuration is safe to ship in the app; private signing material
 * remains exclusively on the trusted proxy.
 */
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Rsa256PixJwtVerifier")))
@interface ZappOfframpRsa256PixJwtVerifier : ZappOfframpBase <ZappOfframpPixJwtVerifier>
- (instancetype)initWithPublicKeyDerBase64:(NSString *)publicKeyDerBase64 expectedKeyId:(NSString *)expectedKeyId __attribute__((swift_name("init(publicKeyDerBase64:expectedKeyId:)"))) __attribute__((objc_designated_initializer));
- (void)verifyAlgorithm:(NSString *)algorithm keyId:(NSString * _Nullable)keyId signingInput:(ZappOfframpKotlinByteArray *)signingInput signature:(ZappOfframpKotlinByteArray *)signature __attribute__((swift_name("verify(algorithm:keyId:signingInput:signature:)")));
@end
...
/** Keeps static PIX available while failing Dynamic PIX closed when trust configuration is absent. */
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UnavailableDynamicPixResolver")))
@interface ZappOfframpUnavailableDynamicPixResolver : ZappOfframpBase <ZappOfframpDynamicPixResolver>
- (instancetype)initWithReason:(NSString *)reason __attribute__((swift_name("init(reason:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UpiQrError.InvalidCurrency")))
@interface ZappOfframpUpiQrErrorInvalidCurrency : ZappOfframpUpiQrError
@property (readonly) NSString *raw __attribute__((swift_name("raw")));
- (instancetype)initWithRaw:(NSString *)raw __attribute__((swift_name("init(raw:)"))) __attribute__((objc_designated_initializer));
- (ZappOfframpUpiQrErrorInvalidCurrency *)doCopyRaw:(NSString *)raw __attribute__((swift_name("doCopy(raw:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
+ (void)Skie_Suspend__41__discardTopUpCheckpointDispatchReceiver:(ZappOfframpAppleOfframpClient *)dispatchReceiver suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__41__discardTopUpCheckpoint(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__42__hasCheckpointDispatchReceiver:(ZappOfframpAppleOfframpClient *)dispatchReceiver suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__42__hasCheckpoint(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__43__hasTopUpCheckpointDispatchReceiver:(ZappOfframpAppleOfframpClient *)dispatchReceiver suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__43__hasTopUpCheckpoint(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__44__historyDispatchReceiver:(ZappOfframpAppleOfframpClient *)dispatchReceiver suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__44__history(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__45__parsePaymentQrDispatchReceiver:(ZappOfframpAppleOfframpClient *)dispatchReceiver currencyCode:(NSString *)currencyCode rawPayload:(NSString *)rawPayload suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__45__parsePaymentQr(dispatchReceiver:currencyCode:rawPayload:suspendHandler:)")));
+ (void)Skie_Suspend__46__quoteDispatchReceiver:(ZappOfframpAppleOfframpClient *)dispatchReceiver currencyCode:(NSString *)currencyCode fiatAmount:(NSString *)fiatAmount suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__46__quote(dispatchReceiver:currencyCode:fiatAmount:suspendHandler:)")));
+ (void)Skie_Suspend__47__topUpCheckpointMicrosDispatchReceiver:(ZappOfframpAppleOfframpClient *)dispatchReceiver suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__47__topUpCheckpointMicros(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__48__requestPaymentDetailsDispatchReceiver:(id<ZappOfframpAppleOfframpPaymentDetailsProvider>)dispatchReceiver orderId:(NSString *)orderId currencyCode:(NSString *)currencyCode fiatAmount:(NSString *)fiatAmount suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__48__requestPaymentDetails(dispatchReceiver:orderId:currencyCode:fiatAmount:suspendHandler:)")));
+ (void)Skie_Suspend__49__createDispatchReceiver:(ZappOfframpAppleOfframpClientCompanion *)dispatchReceiver networkName:(NSString *)networkName seedPhrase:(NSString *)seedPhrase pimlicoApiKey:(NSString *)pimlicoApiKey storage:(id<ZappOfframpAppleOfframpStorage>)storage bridge:(id<ZappOfframpAppleOfframpBridge> _Nullable)bridge rpcUrl:(NSString * _Nullable)rpcUrl subgraphUrl:(NSString * _Nullable)subgraphUrl sponsorshipPolicyId:(NSString * _Nullable)sponsorshipPolicyId pixProxyUrl:(NSString * _Nullable)pixProxyUrl pixJwtPublicKeyBase64:(NSString * _Nullable)pixJwtPublicKeyBase64 pixJwtKeyId:(NSString * _Nullable)pixJwtKeyId suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__49__create(dispatchReceiver:networkName:seedPhrase:pimlicoApiKey:storage:bridge:rpcUrl:subgraphUrl:sponsorshipPolicyId:pixProxyUrl:pixJwtPublicKeyBase64:pixJwtKeyId:suspendHandler:)")));
...
+ (void)Skie_Suspend__50__ensureFundedDispatchReceiver:(id<ZappOfframpOfframpFunding>)dispatchReceiver account:(ZappOfframpAddress *)account request:(ZappOfframpOfframpRequest *)request resumeHandle:(NSString * _Nullable)resumeHandle onBridgeStarted:(id<ZappOfframpKotlinSuspendFunction1>)onBridgeStarted suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__50__ensureFunded(dispatchReceiver:account:request:resumeHandle:onBridgeStarted:suspendHandler:)")));
+ (void)Skie_Suspend__51__invokeDispatchReceiver:(id<ZappOfframpKotlinSuspendFunction1>)dispatchReceiver p1:(id _Nullable)p1 suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__51__invoke(dispatchReceiver:p1:suspendHandler:)")));
+ (void)Skie_Suspend__52__awaitSettlementDispatchReceiver:(id<ZappOfframpOfframpRefund>)dispatchReceiver handle:(NSString *)handle suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__52__awaitSettlement(dispatchReceiver:handle:suspendHandler:)")));
+ (void)Skie_Suspend__53__markTransferStartingDispatchReceiver:(id<ZappOfframpOfframpRefund>)dispatchReceiver handle:(NSString *)handle amount:(id)amount suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__53__markTransferStarting(dispatchReceiver:handle:amount:suspendHandler:)")));
+ (void)Skie_Suspend__54__markTransferSubmittedDispatchReceiver:(id<ZappOfframpOfframpRefund>)dispatchReceiver handle:(NSString *)handle amount:(id)amount txHash:(ZappOfframpTxHash *)txHash suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__54__markTransferSubmitted(dispatchReceiver:handle:amount:txHash:suspendHandler:)")));
+ (void)Skie_Suspend__55__pullbackTargetDispatchReceiver:(id<ZappOfframpOfframpRefund>)dispatchReceiver account:(ZappOfframpAddress *)account amount:(id)amount suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__55__pullbackTarget(dispatchReceiver:account:amount:suspendHandler:)")));
+ (void)Skie_Suspend__56__bridgeDispatchReceiver:(id<ZappOfframpOfframpTopUp>)dispatchReceiver account:(ZappOfframpAddress *)account usdc:(id)usdc resumeHandle:(NSString * _Nullable)resumeHandle onBridgeStarted:(id<ZappOfframpKotlinSuspendFunction1>)onBridgeStarted suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__56__bridge(dispatchReceiver:account:usdc:resumeHandle:onBridgeStarted:suspendHandler:)")));
+ (void)Skie_Suspend__57__requestPaymentDetailsDispatchReceiver:(id<ZappOfframpOfframpPaymentDetailsProvider>)dispatchReceiver orderId:(ZappOfframpBigInteger *)orderId accepted:(ZappOfframpOrderSnapshot *)accepted request:(ZappOfframpOfframpRequest *)request suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__57__requestPaymentDetails(dispatchReceiver:orderId:accepted:request:suspendHandler:)")));
+ (void)Skie_Suspend__58__getDispatchReceiver:(id<ZappOfframpOrderRecipientUpiCache>)dispatchReceiver orderId:(NSString *)orderId suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__58__get(dispatchReceiver:orderId:suspendHandler:)")));
+ (void)Skie_Suspend__59__putDispatchReceiver:(id<ZappOfframpOrderRecipientUpiCache>)dispatchReceiver orderId:(NSString *)orderId recipientUpi:(NSString *)recipientUpi suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__59__put(dispatchReceiver:orderId:recipientUpi:suspendHandler:)")));
...
+ (void)Skie_Suspend__60__getDispatchReceiver:(id<ZappOfframpRelayIdentityStore>)dispatchReceiver suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__60__get(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__61__setDispatchReceiver:(id<ZappOfframpRelayIdentityStore>)dispatchReceiver identity:(ZappOfframpRelayIdentity *)identity suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__61__set(dispatchReceiver:identity:suspendHandler:)")));
+ (void)Skie_Suspend__62__selectCircleForOrderDispatchReceiver:(ZappOfframpCircleRouter *)dispatchReceiver circles:(NSArray<ZappOfframpCircleForRouting *> *)circles orderCurrency:(NSString *)orderCurrency validateCircle:(id<ZappOfframpKotlinSuspendFunction1>)validateCircle suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__62__selectCircleForOrder(dispatchReceiver:circles:orderCurrency:validateCircle:suspendHandler:)")));
+ (void)Skie_Suspend__63__fetchOrderDispatchReceiver:(id<ZappOfframpOrderReadSource>)dispatchReceiver orderId:(ZappOfframpBigInteger *)orderId suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__63__fetchOrder(dispatchReceiver:orderId:suspendHandler:)")));
+ (void)Skie_Suspend__64__circlesForRoutingDispatchReceiver:(ZappOfframpSubgraphClient *)dispatchReceiver currencyBytes32Hex:(NSString *)currencyBytes32Hex suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__64__circlesForRouting(dispatchReceiver:currencyBytes32Hex:suspendHandler:)")));
+ (void)Skie_Suspend__65__ordersForUserDispatchReceiver:(ZappOfframpSubgraphClient *)dispatchReceiver userAddress:(NSString *)userAddress first:(int32_t)first skip:(int32_t)skip suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__65__ordersForUser(dispatchReceiver:userAddress:first:skip:suspendHandler:)")));
+ (void)Skie_Suspend__66__rawOrderByIdDispatchReceiver:(ZappOfframpSubgraphClient *)dispatchReceiver orderId:(NSString *)orderId suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__66__rawOrderById(dispatchReceiver:orderId:suspendHandler:)")));
+ (void)Skie_Suspend__67__isMerchantAvailableDispatchReceiver:(id<ZappOfframpOfframpDriver>)dispatchReceiver usdc:(id)usdc currency:(ZappOfframpCurrencyCode *)currency suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__67__isMerchantAvailable(dispatchReceiver:usdc:currency:suspendHandler:)")));
+ (void)Skie_Suspend__68__resolveAmountDispatchReceiver:(id<ZappOfframpDynamicPixResolver>)dispatchReceiver locationUrl:(NSString *)locationUrl orderId:(NSString * _Nullable)orderId suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__68__resolveAmount(dispatchReceiver:locationUrl:orderId:suspendHandler:)")));
+ (void)Skie_Suspend__69__fetchAllDispatchReceiver:(ZappOfframpP2pOrderHistorySource *)dispatchReceiver userAddress:(ZappOfframpAddress *)userAddress maxOrders:(int32_t)maxOrders suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__69__fetchAll(dispatchReceiver:userAddress:maxOrders:suspendHandler:)")));
...
+ (void)Skie_Suspend__70__parseDispatchReceiver:(ZappOfframpPaymentQrParser *)dispatchReceiver currency:(ZappOfframpCurrencyCode *)currency qrData:(NSString *)qrData dynamicPixResolver:(id<ZappOfframpDynamicPixResolver> _Nullable)dynamicPixResolver orderId:(NSString * _Nullable)orderId suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__70__parse(dispatchReceiver:currency:qrData:dynamicPixResolver:orderId:suspendHandler:)")));
+ (void)Skie_Suspend__71__parseDispatchReceiver:(ZappOfframpPixQrParser *)dispatchReceiver qrData:(NSString *)qrData resolver:(id<ZappOfframpDynamicPixResolver> _Nullable)resolver orderId:(NSString * _Nullable)orderId suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__71__parse(dispatchReceiver:qrData:resolver:orderId:suspendHandler:)")));
+ (void)Skie_Suspend__72__upgradeDispatchReceiver:(ZappOfframpKtor_httpOutgoingContentProtocolUpgrade *)dispatchReceiver input:(id<ZappOfframpKtor_ioByteReadChannel>)input output:(id<ZappOfframpKtor_ioByteWriteChannel>)output engineContext:(id<ZappOfframpKotlinCoroutineContext>)engineContext userContext:(id<ZappOfframpKotlinCoroutineContext>)userContext suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__72__upgrade(dispatchReceiver:input:output:engineContext:userContext:suspendHandler:)")));
+ (void)Skie_Suspend__73__flushDispatchReceiver:(id<ZappOfframpKtor_ioByteWriteChannel>)dispatchReceiver suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__73__flush(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__74__flushAndCloseDispatchReceiver:(id<ZappOfframpKtor_ioByteWriteChannel>)dispatchReceiver suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__74__flushAndClose(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__75__writeToDispatchReceiver:(ZappOfframpKtor_httpOutgoingContentWriteChannelContent *)dispatchReceiver channel:(id<ZappOfframpKtor_ioByteWriteChannel>)channel suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__75__writeTo(dispatchReceiver:channel:suspendHandler:)")));
+ (void)Skie_Suspend__76__getUsdcBalanceExtensionReceiver:(ZappOfframpBaseRpcClient *)extensionReceiver usdcAddress:(ZappOfframpAddress *)usdcAddress owner:(ZappOfframpAddress *)owner suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__76__getUsdcBalance(extensionReceiver:usdcAddress:owner:suspendHandler:)")));
+ (void)Skie_Suspend__77__getAdditionalOrderDetailsExtensionReceiver:(ZappOfframpBaseRpcClient *)extensionReceiver diamondAddress:(ZappOfframpAddress *)diamondAddress orderId:(ZappOfframpBigInteger *)orderId suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__77__getAdditionalOrderDetails(extensionReceiver:diamondAddress:orderId:suspendHandler:)")));
+ (void)Skie_Suspend__78__getPriceConfigExtensionReceiver:(ZappOfframpBaseRpcClient *)extensionReceiver diamondAddress:(ZappOfframpAddress *)diamondAddress currency:(ZappOfframpCurrencyCode *)currency suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__78__getPriceConfig(extensionReceiver:diamondAddress:currency:suspendHandler:)")));
+ (void)Skie_Suspend__79__getPayFeeConfigExtensionReceiver:(ZappOfframpBaseRpcClient *)extensionReceiver diamondAddress:(ZappOfframpAddress *)diamondAddress currency:(ZappOfframpCurrencyCode *)currency suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__79__getPayFeeConfig(extensionReceiver:diamondAddress:currency:suspendHandler:)")));
...
+ (void)Skie_Suspend__80__getSmallOrderFixedFeePayExtensionReceiver:(ZappOfframpBaseRpcClient *)extensionReceiver diamondAddress:(ZappOfframpAddress *)diamondAddress currency:(ZappOfframpCurrencyCode *)currency suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__80__getSmallOrderFixedFeePay(extensionReceiver:diamondAddress:currency:suspendHandler:)")));
+ (void)Skie_Suspend__81__getSmallOrderThresholdExtensionReceiver:(ZappOfframpBaseRpcClient *)extensionReceiver diamondAddress:(ZappOfframpAddress *)diamondAddress currency:(ZappOfframpCurrencyCode *)currency suspendHandler:(ZappOfframpSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__81__getSmallOrderThreshold(extensionReceiver:diamondAddress:currency:suspendHandler:)")));
