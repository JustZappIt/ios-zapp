...
struct ServerSetupView: View {
            ...
            .zashiBack(
                ...
                primaryAction: {
                    ZappButton(
                        ...
                        isEnabled: canSave && !store.isUpdatingServer
                    ) {
    ...
    private var canSave: Bool {
        ...
        let needsServer = store.connectionMode == .manual
            && (store.selectedServer == nil || customIsInvalid)
        return store.hasChanges && !needsServer
    }
