...
final class AppDelegate: NSObject, UIApplicationDelegate {
    ...
    private lazy var notificationDelegateDispatcher = NotificationDelegateDispatcher(
        migration: migrationNotificationDelegate,
    ...
    func application(
        ...
        // Assigned AFTER ChatPushNotifications.configure, which claims the slot for itself; the
        // dispatcher routes each notification to whichever subsystem owns it.
        UNUserNotificationCenter.current().delegate = notificationDelegateDispatcher
