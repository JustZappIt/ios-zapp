...
extension SDKSynchronizerClient: TestDependencyKey {
    static let testValue = Self(
        ...
        getTransactionOverviews: unimplemented("\(Self.self).getTransactionOverviews", placeholder: []),
        getOverviewRecipients: unimplemented("\(Self.self).getOverviewRecipients", placeholder: []),
        createProposedTransactionsWithoutSubmit: unimplemented("\(Self.self).createProposedTransactionsWithoutSubmit", placeholder: []),
        submitCreatedTransactionsForGift: unimplemented("\(Self.self).submitCreatedTransactionsForGift", placeholder: .success(txIds: [])),
        ...
        createTransactionFromPCZTWithoutSubmit: unimplemented("\(Self.self).createTransactionFromPCZTWithoutSubmit", placeholder: []),
...
extension SDKSynchronizerClient {
    static let noOp = Self(
        ...
        getOverviewRecipients: { _ in [] },
        createProposedTransactionsWithoutSubmit: { _, _ in [] },
        submitCreatedTransactionsForGift: { _ in .success(txIds: []) },
        ...
        createTransactionFromPCZTWithoutSubmit: { _, _ in [] },
...
extension SDKSynchronizerClient {
    ...
    importAccount: @escaping @Sendable (String, [UInt8]?, Zip32AccountIndex?, AccountPurpose, String, String?, BlockHeight?) async throws -> AccountUUID? = { _, _, _, _, _, _, _ in nil },
        ...
        getTransactionOverviews: @escaping @Sendable () async throws -> [ZcashTransaction.Overview] = { [] },
        getOverviewRecipients: @escaping @Sendable (ZcashTransaction.Overview) async -> [TransactionRecipient] = { _ in [] },
        createProposedTransactionsWithoutSubmit:
        @escaping @Sendable (Proposal, UnifiedSpendingKey) async throws -> [CreatedTransaction] = { _, _ in [] },
        submitCreatedTransactionsForGift:
        @escaping @Sendable ([CreatedTransaction]) async throws -> CreateProposedTransactionsResult = { _ in .success(txIds: []) },
        ...
        createTransactionFromPCZTWithoutSubmit: @escaping @Sendable (Pczt, Pczt) async throws -> [CreatedTransaction] = { _, _ in [] },
        ...
        SDKSynchronizerClient(
            ...
            getTransactionOverviews: getTransactionOverviews,
            getOverviewRecipients: getOverviewRecipients,
            createProposedTransactionsWithoutSubmit: createProposedTransactionsWithoutSubmit,
            submitCreatedTransactionsForGift: submitCreatedTransactionsForGift,
            ...
            createTransactionFromPCZTWithoutSubmit: createTransactionFromPCZTWithoutSubmit,
