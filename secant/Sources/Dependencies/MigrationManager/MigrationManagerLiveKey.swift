...
final class MigrationManagerImpl: @unchecked Sendable {
    ...
    /// True while LONG migration work occupies the synchronizer — see the
    ...
    /// serialization. Nine broadcast sessions in one run, nine slow reads, growing with the run:
    ///
    ...
    /// CONDITION (the synchronizer is busy) rather than after one of its causes is what stops a third
