...
- [ZAPP-1] The Pay screen now leads with your local-currency balance and shows the ZEC value underneath when a rate is available; tapping swaps them so ZEC takes the headline with local currency beneath. The activity list follows whichever you pick, and the balance now animates in place when it changes instead of jumping.
